            ...
            {COL_ORDER.map((j) => {
              ...
              return (
                <th key={j}
                  ...
                  className="sticky z-10 bg-white px-4 py-2 font-bold whitespace-nowrap cursor-pointer select-none hover:opacity-70 leading-tight border-b border-gray-200"
  ...
  return (
    <div style={{ position: "fixed", top: 0, left: "12rem", right: 0, bottom: 0,
      ...
      <div style={{ flex: 1, minHeight: 0, overflow: "auto", padding: "0 24px 24px" }}>
        ...
        {!loading && !error && (
          <div className="border border-t-0 border-gray-200 rounded-b-xl shadow-sm overflow-x-auto">
